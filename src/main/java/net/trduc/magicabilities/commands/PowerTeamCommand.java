        ...
        switch (sub){
            case "create": {
                ...
                if (args.length < 2){
                    ...
                    sender.sendMessage(ChatColor.GRAY + "Omit color to get a random one. Suggested colors: " + net.trduc.magicabilitiesfork.misc.TeamColorSync.suggestedColorsList());
                    return true;
                }
                String teamName = args[1];
                org.bukkit.ChatColor colorEnum;
                if (args.length >= 3){
                    colorEnum = net.trduc.magicabilitiesfork.misc.TeamColorSync.parseColor(args[2]);
                    if (colorEnum == null){
                    ...
                    colorEnum = net.trduc.magicabilitiesfork.misc.TeamColorSync.randomColor();
                }
                ...
                net.trduc.magicabilitiesfork.misc.TeamColorSync.syncTeamColor(teamName, color);
                net.trduc.magicabilitiesfork.misc.TeamColorSync.syncPlayer(db, (Player) sender);
                sender.sendMessage(ChatColor.GREEN + "Created team " + teamName + " and added you as member. Team color: " + colorEnum + color);
                return true;
            }
            case "add":
                if (args.length == 2 && sender instanceof Player){
                    ...
                    if (isOwner || sender.hasPermission("magic.admin")){
                        ...
                        if (added){
                            Player addedP = Bukkit.getPlayer(playerToAdd);
                            if (addedP != null) net.trduc.magicabilitiesfork.misc.TeamColorSync.syncPlayer(db, addedP);
                        }
            ...
            case "accept":
                ...
                if (okAccept) net.trduc.magicabilitiesfork.misc.TeamColorSync.syncPlayer(db, (Player) sender);
            ...
            case "remove":
                if (args.length == 2 && sender instanceof Player){
                    ...
                    if (isOwner || sender.hasPermission("magic.admin")){
                        ...
                        if (rem){
                            Player removedP = Bukkit.getPlayer(playerToRemove);
                            if (removedP != null) net.trduc.magicabilitiesfork.misc.TeamColorSync.syncPlayer(db, removedP);
                        }
            ...
            case "list":
                ...
                if (args.length == 1 && sender instanceof Player){
                    Player viewerP = (Player) sender;
                    if (MagicAbilitiesfork.magicPlugin != null && MagicAbilitiesfork.magicPlugin.powerTeamListGui != null){
                        MagicAbilitiesfork.magicPlugin.powerTeamListGui.openTeamListGui(viewerP);
                        return true;
                    }
