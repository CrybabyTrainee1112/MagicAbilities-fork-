...
public final class CooldownValidator {
    ...
    private static final List<String> REQUIRED_KEYS = Arrays.asList(
        ...
        "ice.multi-bolt", "ice.slashes", "ice.phase-change", "ice.freeze-counter",
        "warp.default",
        ...
        "demonlord.judgment", "demonlord.fury", "demonlord.counter",
        ...
        "assassin.shadowstep", "assassin.knives", "assassin.smokeveil", "assassin.backstab",
        "assassin.clone", "assassin.vanish", "assassin.nightofcuts",
        "chronarch.bolt", "chronarch.rewind", "chronarch.haste", "chronarch.stasis",
        "chronarch.field", "chronarch.echo", "chronarch.precog", "chronarch.flicker", "chronarch.zerohour",
        "cosmic.comet", "cosmic.step", "cosmic.nebula", "cosmic.pulsar", "cosmic.guard", "cosmic.supernova",
        "kagemusha.ambush", "kagemusha.dance", "kagemusha.swap",
        "kagemusha.converge", "kagemusha.diverge", "kagemusha.frenzy",
        "puppeteer.string", "puppeteer.yank", "puppeteer.swap", "puppeteer.march",
        "puppeteer.cut", "puppeteer.web", "puppeteer.loose", "puppeteer.danse",
        "venompalette.trigger", "venompalette.canvas", "venompalette.inject",
        "venompalette.antidote", "venompalette.masterpiece"
    );
